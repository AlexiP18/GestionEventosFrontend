...
export class SignupCompanyComponent {
  //creo el objeto del formulario
  validateForm!: FormGroup;
  //para inyectar en la api
  constructor(
  ...
  //Controles para el formulario en equipos cambia la direccion
  ngOnInit() {
  ...
  //metodo de envio llamando a la api del backend
  submitForm() {
